package com.appweaverx.auth.config;
...
import com.appweaverx.auth.config.KeycloakServerProperties.AdminUser;
...
public class EmbeddedKeycloakApplication extends KeycloakApplication {
	...
	private void createAppWeaverXRealm() {
		KeycloakSession session = getSessionFactory().create();
